    ...
    componentWillMount() {
        ...
        this.PanResponder = PanResponder.create({
            ...
            onPanResponderRelease: (evt, gestureState) => {
                ...
                if (this.state.currentIndex > 0 && gestureState.dy > 50 && gestureState.vy > 0.4) {
                ...
                else if (-gestureState.dy > 50 && -gestureState.vy > 0.4 && this.state.currentIndex < ARTICLES.length - 1) { 
                  Animated.timing(this.position, { toValue: ({ x: 0, y: -SCREEN_HEIGHT }), 
                  duration: 400 }).start(() => { 
                  this.setState({ currentIndex: this.state.currentIndex + 1 }) 
...
AppRegistry.registerComponent('wallrafapp', () => DeckSwiper);